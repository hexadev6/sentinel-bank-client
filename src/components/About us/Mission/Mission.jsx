...
const Mission = () => {
  return (
    <Container>
      <div
        id="mission"
        className="grid grid-cols-1 lg:grid-cols-2 h-auto gap-4 mx-6"
      >
        <div className=" p-2 ">
          <SubHeading title={"Our Mission"}></SubHeading>
          <h2 className="my-4 text-[#073871] text-left p-2 text-lg font-medium">
            ...
            building lasting relationships with our clients, fostering a culture
            of trust, integrity, and transparency. Through responsible banking
            practices, community engagement, and a dedication to excellence, we
            strive to be a trusted financial partner, contributing to the
            prosperity and well-being of the communities we serve
          </h2>
        </div>
