...
const Awards = () => {
  return (
    <Container>
      ...
      <div
        id="awards"
        className="my-4 grid grid-cols-1 md:grid-cols-2 gap-4 lg:grid-cols-4 justify-between items-center"
      >
        ...
        <div className="w-60 text-center text-xl font-bold">
          <img className="h-60 w-60" src={award3} alt="" />
          <h2>Community Impact Recognition</h2>
        </div>
        <div className="w-60 text-center text-xl font-bold">
