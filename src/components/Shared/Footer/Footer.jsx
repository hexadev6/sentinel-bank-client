...
const Footer = () => {
  const LINKS = [
    {
      title: "Useful Links",
      items: ["Home", "Service", "About us", "Contact", "Feature"],
    },
    {
      title: "Resource",
        ...
        <div className="mx-auto container px-4">
          <div className="grid grid-cols-1  justify-between gap-10 lg:grid-cols-3">
            <div>
              ...
              <p className="font-semibold mt-5">Follow Us</p>

              <div className="flex gap-4  flex-wrap mt-2 text-white">
                <Typography
                  as="a"
                  href="#"
            ...
            <div className="col-span-2 flex flex-wrap sm:grid grid-cols-3 sm:justify-between gap-4 t">
              ...
              <div>
                ...
                <p>Dont miss to subscribe our news feed to get best offers.</p>
                <Typography
                  variant="small"
                  color="blue-gray"
                  className="my-3 font-semibold text-sm opacity-90 text-white"
                >
                  Address
                </Typography>
                <p>567 Waterfront Road, Waterfront City, State, ZIP</p>
              </div>
            </div>
          </div>
        </div>
