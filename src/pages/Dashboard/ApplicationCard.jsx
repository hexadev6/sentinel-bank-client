...
const ApplicationCard = () => {
  return (
    <>
      <div className="p-5 min-h-screen  w-full flex flex-col-reverse xl:flex-row  justify-center items-center -mt-20 ">
        ...
        <div className="flex-1 ">
          <img className=" w-full  mt-20  xl:mt-0 " src={debit} alt="" />
        </div>
      </div>
    </>
  );
