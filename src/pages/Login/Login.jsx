...
const Login = () => {
  ...
  return (
    <div>
      <FormContainer>
        <StyledForm
          className="border border-nevy-blue mx-5"
          ...
          <div>
            <div className="p-10">
              ...
              <h2 className="text-sm mb-4">
                If you don't have any acount. It's simple to{" "}
                <Link
                  className=" p-1 text-nevy-blue transition-all duration-300  hover:underline"
                  to="/registration"
                >
                  {" "}
                  create your account
              ...
              <Button className="w-full bg-nevy-blue" type="submit">
                login
              </Button>
            </div>
          </div>
